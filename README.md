...
[Week 2](https://docs.google.com/presentation/d/1zw91qO8TVa8kbLKNZ6MTjhSkF1C0GKood3-pSbTDmKM/edit?usp=sharing)<br>Week of 02/01/2021 | **Week 2: Toward C** <ul><li>	Part 2.1: IO and Compilation <li>Part 2.2: C types and Declaration <li>Part 2.3: Conditionals and Loops<li>Part 2.4: Functions <li>Part 2.5: Arrays and strings</ul> |<ul><li>[TODO]() <li> [TODO]() </ul>|<ul> <li>[Chapter 1 through 1.6](https://diveintosystems.org/singlepage/#_by_the_c_by_the_c_by_the_beautiful_c) <li>[Chapter 3.1 gdb](https://diveintosystems.org/singlepage/#_debugging_with_gdb)</ul>|[Coding Exercises](https://diveintosystems.org/antora/diveintosystems/1.0/C_intro/exercises.html)  | <ul><li>Assignment#1 due 02/06/2021 <li> Assignment#2 out 02/03/2021 </ul>
# Hands-out
