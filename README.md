...
[Week 3](https://kami.app/T0vE6O6pVCRx)<br>Week of 02/08/2021 | **Week 2: Deep Dive into C** <ul><li>	Part 3.1: Pointers and functions <li>Part 3.2: Strings and arrays <li>Part 3.3: Floating point representation <li>Part 3.4: Dynamic Memory Allocation <li>Part 3.5: GDB debugging</ul> |<ul><li>[3-1. dive into C pointers](https://pace.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=d5164271-6339-404e-96d9-acc9018788c7) <li> [TODO]() <li> [TODO]() </ul>|<ul> <li>[Chapter 2 through 2.7](https://diveintosystems.org/antora/diveintosystems/1.0/C_depth/index.html) <li>[Chapter 3.1 gdb](https://diveintosystems.org/singlepage/#_debugging_with_gdb)</ul>|[Floating-point & C pointers](https://docs.google.com/document/d/1SE4gPBtIcPd6UdCxmXSCy6ySbkMJuT56KOH2ZP28Y7A/edit?usp=sharing)  | <ul><li>Assignment#2 due 02/13/2021 </ul>
# Hands-out
